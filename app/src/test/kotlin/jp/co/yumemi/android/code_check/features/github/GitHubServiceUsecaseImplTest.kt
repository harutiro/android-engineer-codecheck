...
class GitHubServiceUsecaseImplTest {
    ...
    @Test
    fun `fetchSearchResults returns success when online`() = runBlocking {
    ...
    @Test
    fun `fetchSearchResults returns error on API failure`() = runBlocking {
    ...
    @Test
    fun `fetchRepositoryDetail returns success when online`() = runBlocking {
    ...
    @Test
    fun `fetchRepositoryDetail returns error on API failure`() = runBlocking {
    ...
    @Test
    fun `fetchRepositoryDetail handles network error`() = runBlocking {
