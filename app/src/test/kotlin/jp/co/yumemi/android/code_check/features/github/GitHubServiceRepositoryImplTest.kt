...
class GitHubServiceRepositoryImplTest {
    ...
    @Test
    fun `fetchRepositoryDetail returns success with valid data`() =
        runBlocking {
            // Arrange
    ...
    @Test
    fun `fetchRepositoryDetail returns error on HttpException`() =
        runBlocking {
            // Arrange
            val httpException = mock(HttpException::class.java)
    ...
    @Test
    fun `fetchRepositoryDetail returns error on IOException`() =
        runBlocking {
            // Arrange
